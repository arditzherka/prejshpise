...
We welcome pull requests from (our students) and seasoned JavaScript developers alike! Follow these steps to contribute:
...
- [Setup Prej Shpise](#setup-prejshpise)
...
1. Go to the top level Pantry-for-Good repository page on github: [https://github.com/go02/prejshpise](https://github.com/go02/prejshpise)
2. Click the "Fork" Button in the upper right hand corner of the interface ([More Details Here](https://help.github.com/articles/fork-a-repo/))
3. After the repository has been forked, you will be taken to your copy of the PrejShpise repo at `yourUsername/prejshpise`

#### Cloning Your Fork

1. Open a Terminal / Command Line / Bash Shell
2. Clone your fork of PrejShpise

```shell
git clone https://github.com/yourUsername/prejshpise.git
```

##### (make sure to replace `yourUsername` with your GitHub Username)

This will create a directory `prejshpise` and download the entire prejshpise repo to it.

#### Setup Your Upstream

1. Change directory to the new prejshpise directory (`cd prejshpise`)
2. Use the git command to add a remote to the official prejshpise repo:

```shell
git remote add upstream https://github.com/go02/prejshpise.git
```

Congratulations, you now have a local copy of the prejshpise repo!
...
2.  Submit a pull request from your branch to go02's prejshpise `staging` branch.
